    ...
    <div>
      <div className="flex items-center justify-between pb-4 border-b mb-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">News and activity signals across all clients.</p>
        </div>
      </div>
      ...
      {!signals.length ? (
        <div className="rounded-lg border p-12 text-center">
          <p className="text-muted-foreground">No signals found. Run a scan on a client to generate signals.</p>
        </div>
      ) : (
